    ...
    return (
        <table>
            <thead className="bg-[#245383] text-white">
                ...
                <th className="px-4 py-2">Fecha da deuda</th>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td className="border px-4 py-2">Pensón</td>
                ...
                <tr>
                    ...
                    <td className="border px-4 py-2">2022</td>
                    <td className="border px-4 py-2">Marzo</td>
                    <td className="border px-4 py-2">Pensón</td>
                    <td className="border px-4 py-2">$ 281.57</td>
                    <td className="border px-4 py-2">Pendiente</td>
                ...
                <tr>
                    ...
                    <td className="border px-4 py-2">2022</td>
                    <td className="border px-4 py-2">Abril</td>
                    <td className="border px-4 py-2">Pensón</td>
                    <td className="border px-4 py-2">$ 281.57</td>
                    <td className="border px-4 py-2">Pendiente</td>
                ...
                <tr>
                    ...
                    <td className="border px-4 py-2">2022</td>
                    <td className="border px-4 py-2">Mayo</td>
                    <td className="border px-4 py-2">Pensón</td>
                    <td className="border px-4 py-2">$ 281.57</td>
                    <td className="border px-4 py-2">Pendiente</td>
                ...
                <tr>
                    ...
                    <td className="border px-4 py-2">2022</td>
                    <td className="border px-4 py-2">Junio</td>
                    <td className="border px-4 py-2">Pensón</td>
                    <td className="border px-4 py-2">$ 281.57</td>
                    <td className="border px-4 py-2">Pendiente</td>
